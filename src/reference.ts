...
export const COMMAND_GROUPS: CommandGroup[] = [
  {
    ...
    commands: [
      {
        usage: "events [list|view|invitees|answers|cancel|no-show] [<args>] [flags]",
        summary: "List upcoming events, inspect invitees, aggregate booking answers, cancel, and mark no-shows",
        flags: [
        ...
        examples: [
          "calendly-axi events",
          "calendly-axi events --window today",
          "calendly-axi events view <uuid>",
          "calendly-axi events invitees <uuid>",
          'calendly-axi events invitees <uuid> --email "ada@example.com"',
          'calendly-axi events answers --type "30 Minute Meeting"',
          "calendly-axi events answers --type <uuid> --since 90d --org",
          "calendly-axi events answers --type <uuid> --utm",
      ...
      {
        usage: "busy [--from --to | --until <dur> | --window <today|tomorrow|week>] [--user <who>]",
        ...
        examples: ["calendly-axi busy", "calendly-axi busy --until 3d", "calendly-axi busy --window today"],
      },
    ],
  },
  {
    ...
    commands: [
      {
        ...
        examples: [
          ...
          'calendly-axi types view "Teammate\'s Type" --org',
          "calendly-axi types slots <uuid> --until 14d",
          "calendly-axi types slots <uuid> --window tomorrow",
          ...
          'calendly-axi types create --name "Intro Call" --duration 30 --location-kind google_conference',
          'calendly-axi types create --name "Intro Call" --duration 30 --location-kind physical --location-text "123 Main St"',
          'calendly-axi types create --name "Kickoff" --duration 30 --owner teammate@example.com',
          ...
          'calendly-axi types update <uuid> --name "New Name" --duration 45   (output includes a `changed:` diff)',
